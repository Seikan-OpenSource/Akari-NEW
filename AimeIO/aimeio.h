 ...
 */
DLL_EXPORT uint16_t aime_io_get_api_version(void);
 ...
 */
DLL_EXPORT HRESULT aime_io_init(void);
...
/*
    ...
    Minimum API version: 0x0100
 */
DLL_EXPORT HRESULT aime_io_nfc_poll(uint8_t unit_no);
...
/*
    ...
    Minimum API version: 0x0100
*/
DLL_EXPORT HRESULT aime_io_nfc_get_aime_id(
    uint8_t unit_no,
    uint8_t* luid,
    size_t luid_size);
...
/*
    ...
    Minimum API version: 0x0100
*/
DLL_EXPORT HRESULT aime_io_nfc_get_felica_id(uint8_t unit_no, uint64_t* IDm);
...
/*
    ...
    Minimum API version: 0x0100
*/
DLL_EXPORT void aime_io_led_set_color(uint8_t unit_no, uint8_t r, uint8_t g, uint8_t b);