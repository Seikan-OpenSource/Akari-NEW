...
__xdata __at (EP1_ADDR) uint8_t Ep1Buffer[64];       //on page 47 of data sheet, the receive buffer need to be min(possible packet size+2,64), IN and OUT buffer, must be even address
// clang-format on
