...
extern uint8_t _felicaIDm[8]; // FeliCa IDm (NFCID2)
extern uint8_t _felicaPMm[8]; // FeliCa PMm (PAD)

extern uint8_t pn532_packetbuffer[64];
extern void pn532_begin(void);
extern bool pn532_SAMConfig(void);

// Generic PN532 functions
extern uint32_t pn532_getFirmwareVersion(void);
